#
# choose best oversampling method based on rf f1 score
#
import pandas as pd
...
#
print("base")
y_pred = rf.fit(X_train0, y_train0).predict(X_test)
...
def scoring(smote_fun):
    ...
    for k_ in range(1,25):
        ...
        #scores.append(confusion_matrix(y_test, y_pred)[2][2] / sum(confusion_matrix(y_test, y_pred)[2]))
...
df_smote.to_csv('df_smote_cv.csv')
